    ...
    <>
      ...
      <div className="min-h-screen bg-background py-12 px-4">
        <div className="max-w-3xl mx-auto prose dark:prose-invert">
          ...
          <p>
            We speak your language. "Compatibility scores"? Been there. "Super-mega-ultra-rare artist discovery"? We salute you. That slight panic when you listen to a guilty pleasure and hope it doesn't mess up your music stats? We've all felt it (or, you know, created a private session).
          </p>
          <p>
